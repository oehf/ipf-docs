---
title: xca-iti38 component
layout: single
permalink: /docs/ihe/iti38/
toc: true
toc_icon: align-left
toc_sticky: true
---

{% assign tx = site.data.ihe["iti38"] %}
...
{% include figure image_path="/assets/images/iti38.svg" alt="ITI-38 actors" caption="ITI-38 transaction and actors " %}
...
`http://eHealth.server.org:8888/IHE/xca/{{ tx.link }}`
