---
title: xdsi-rad69 component
layout: single
permalink: /docs/ihe/rad69/
toc: true
toc_icon: align-left
toc_sticky: true
---

{% assign tx = site.data.ihe["rad69"] %}
...
{% include figure image_path="/assets/images/rad69.svg" alt="RAD-69 actors" caption="RAD-69 transaction and actors " %}
...
`http://eHealth.server.org:8888/IHE/xdsi/{{ tx.link }}`
