---
title: cmpd-pharm1 component
layout: single
permalink: /docs/ihe/pharm1/
toc: true
toc_icon: align-left
toc_sticky: true
---

{% assign tx = site.data.ihe["pharm1"] %}
...
{% include figure image_path="/assets/images/pharm1.svg" alt="PHARM-1 actors" caption="PHARM-1 transaction and actors " %}
