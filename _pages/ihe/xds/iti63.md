---
title: xcf-iti63 component
layout: single
permalink: /docs/ihe/iti63/
toc: true
toc_icon: align-left
toc_sticky: true
---

{% assign tx = site.data.ihe["iti63"] %}
...
{% include figure image_path="/assets/images/iti63.svg" alt="ITI-63 actors" caption="ITI-63 transaction and actors " %}
...
`http://eHealth.server.org:8888/IHE/xcf/{{ tx.link }}`
