---
title: chadr component
layout: single
permalink: /docs/ihe/chadr/
toc: true
toc_icon: align-left
toc_sticky: true
---

{% assign tx = site.data.ihe["chadr"] %}
...
{% include figure image_path="/assets/images/chadr.svg" alt="CH:ADR actors" caption="CH:ADR transaction and actors " %}
