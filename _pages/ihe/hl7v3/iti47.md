---
title: pdqv3-iti47 component
layout: single
permalink: /docs/ihe/iti47/
toc: true
toc_icon: align-left
toc_sticky: true
---

{% assign tx = site.data.ihe["iti47"] %}
...
{% include figure image_path="/assets/images/iti47.svg" alt="ITI-47 actors" caption="ITI-47 transaction and actors " %}
...
[Interactive response message continuation]: {{ site.baseurl }}{% link _pages/ihe/hl7v3/hl7v3InteractiveContinuation.md %}
